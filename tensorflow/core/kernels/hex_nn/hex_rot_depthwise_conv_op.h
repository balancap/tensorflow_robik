...
template <typename T>
struct HexRotDepthwiseFilterPadOp {
  void operator()(const HexRotDepthwiseArgs& args, const T* filter,
                  T* padded_filter) {
...
template <typename T>
struct HexRotDepthwiseInputCopyOp {
  void operator()(const HexRotDepthwiseArgs& args,
